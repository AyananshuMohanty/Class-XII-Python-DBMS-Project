...
connection_object=mysql.connector.connect (host="DESKTOP-GGWPEZ4", user="Ayananshu",\
                                           passwd="undergroundSamurai", database="employee_management")
...
def register_employee():
    ...
    *This function can be accessed by Level 2 Employees only.*
    ...
    cursor.execute("insert into employee_info values('{}','{}','{}','{}','{}',{},{},{},'{}')"\
                   .format(emp_id,emp_name,emp_gen,emp_dept,emp_level,emp_salary,emp_age,emp_doj,emp_pas))
...
def alter_personal_info(employee_id):
    ...
    if ch==1:
        ...
        cursor.execute("update employee_info set Department='{}' where ID='{}'"\
                       .format(dept,employee_id))
        connection_object.commit()
...
def change_password():
    ...
    (Password must be greater than 8 characters in length and must have atleast 1 lowercase character,
    ...
    print("""Password must have atleast 1 lowercase character, 1 uppercase character, 1 number,\
...
def password_confirm(newpass):
    ...
    if newpass == newpasscon:
        cursor.execute("update employee_info set Password = '{}' where ID='{}'"\
                       .format(newpass,employee_id))
        connection_object.commit()
...
def alter_level_one_info():
    """
    Allows Level 2 Employees to alter the Department and increase Salary of Level 1 Employees.
    """
    ...
    if emp_id in data_list:
        ...
        if ch==1:
            ...
            connection_object.commit()
            print("Salary increased by 10% successfully. New Salary=",sal)
            print("")
    else:
